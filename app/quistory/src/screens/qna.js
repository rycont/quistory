    ...
    const QnaScreenWithData = withTitleAndContent('질문')(false)({})(({ style }) => {
        return (<View style={style}>
            ...
            <QuestionCard navigate={navigate} author={{
                name: '클리앙',
                profileImage: 'http://image.musinsa.com/data/celeb/6570/6570_1_org.jpg'
            }} content={`1kg 정도 무게에 가벼운 게이밍이 가능한 14인치 노트북을 알아보던중 작년말에 출시한 ASUS 젠북 UX433FN 모델이 눈에 띄더라구요
...
제가 노트북을 잘 알지는 못하지만 같은 모델 구입을 고려중이신 분들이나 비슷한 쓰로틀링 문제를 겪고 계신분들께 혹시 도움이 될까 싶어서 글을 올려봤습니다.`} date={new Date()} metoo={293} />
            <QuestionCard navigate={navigate} author={{
                name: '또율',
                profileImage: 'http://image.musinsa.com/data/celeb/6570/6570_1_org.jpg'
            }} content={`안녕하세요 달덩이또율이 입니다.
시작하기 앞서 저는
100만원대 유선이어폰
50만원이하 코드리스제품을
많이 써본 리스너 입니다
...
양감저음 입니다
소니의 양감저음과는 다른
젠하이저의 묵직함이 느껴집니다`} date={new Date()} />
            <QuestionCard navigate={navigate} author={{
                name: '또율',
                profileImage: 'http://image.musinsa.com/data/celeb/6570/6570_1_org.jpg'
            }} content={`안녕하세요 달덩이또율이 입니다.
...
양감저음 입니다
소니의 양감저음과는 다른
젠하이저의 묵직함이 느껴집니다`} date={new Date()} metoo={0} />
        </View>)
    })
    return (
        <QnaScreenWithData />
