  ...
  <WrongProblem key={item.index}>
    ...
    <Contents
      style={{
        ...
        {item.quizsubunit && <SubunitText>{item.quizsubunit.quizlargeunit.largeunit} > {item.quizsubunit.subunit}</SubunitText>}
      ...
      {{
        shortAnswer: quiz => (
          <>
            ...
            {!!quiz.otherAnswers.length && <CorrectToo>
