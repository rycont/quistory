...
export default ({navigation: {
    ...
    const QnaScreenWithData = withTitleAndContent('질문')(false)(() => {
        return (<React.Fragment>
            <QuestionCard navigate={navigate} author="클리앙" content={`여기엔 트위터스러운 짧은 문구가 어울립니다.`} date="2019-04-11 13:41:26" />
            <QuestionCard navigate={navigate} author="클리앙" content={`1kg 정도 무게에 가벼운 게이밍이 가능한 14인치 노트북을 알아보던중 작년말에 출시한 ASUS 젠북 UX433FN 모델이 눈에 띄더라구요
...
제가 노트북을 잘 알지는 못하지만 같은 모델 구입을 고려중이신 분들이나 비슷한 쓰로틀링 문제를 겪고 계신분들께 혹시 도움이 될까 싶어서 글을 올려봤습니다.`} />
            <QuestionCard navigate={navigate} author="달덩이또율이" content={`안녕하세요 달덩이또율이 입니다
시작하기 앞서 저는
100만원대 유선이어폰
50만원이하 코드리스제품을
많이 써본 리스너 입니다
